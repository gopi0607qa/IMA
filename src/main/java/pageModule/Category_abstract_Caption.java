...
public class Category_abstract_Caption extends Testbase {
	...
	public void Category(ExtentTest test, WebDriver driver, String Header) throws IOException {
		...
		fun.Click(driver, catUI_xp.Abstract_Nature_Page);
		...
		String shop = catUI_xp.Category_Product_List_Header_Title.getText();
		...
		while (catUI_xp.next_page.isDisplayed() == true) {
			...
			if (shop.equalsIgnoreCase(Header)) {
				...
				fun.Scroll(driver, catUI_xp.Category_Product_List_Header_Title);
			...
			try {
				...
				fun.Scroll(driver, catUI_xp.Pagination_currentpage);
				System.out.println("Page number Dot is present");
				test.log(Status.PASS, "Page number Dot is present",
						MediaEntityBuilder.createScreenCaptureFromPath(fun.capturescreenshot(driver)).build());

			}
			// else if(catUI_xp.Pagination_dot.isDisplayed()==false){

			catch (NoSuchElementException e) {
				fun.Scroll(driver, catUI_xp.Pagination_currentpage);
				System.out.println("Page number Dot is not present in Pagination");
				test.log(Status.FAIL, "Page number Dot is present in Pagination",
						MediaEntityBuilder.createScreenCaptureFromPath(fun.capturescreenshot(driver)).build());
				e.printStackTrace();
			...
			if (catUI_xp.next_page.isDisplayed() == true) {
				...
				test.log(Status.FAIL, "Next page number is not present end of Pagination",
						MediaEntityBuilder.createScreenCaptureFromPath(fun.capturescreenshot(driver)).build());
	...
	public void lastpage(ExtentTest test, WebDriver driver, String Header) throws IOException {
		...
		Category_abstract_Caption cap = new Category_abstract_Caption();
