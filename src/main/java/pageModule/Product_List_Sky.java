...
public class Product_List_Sky extends Testbase {
	...
	public void Product_List(ExtentTest test, WebDriver driver) throws InterruptedException, IOException, AWTException {
		...
		fun.Click(driver, Prod_Li_xp.Sky_Page);
		...
		try {
			...
			for (String product : products) {
				...
				XSSFSheet sheet = book.createSheet("Sky");
				...
				FileOutputStream out = new FileOutputStream(
						new File("C:\\eclipse\\orange_coast\\src\\test\\resources\\excel\\Sky.xlsx")); // file name with
																										// path
				book.write(out);
				out.close();
