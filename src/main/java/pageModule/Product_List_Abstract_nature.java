...
public class Product_List_Abstract_nature extends Testbase {
	...
	public void Product_List(ExtentTest test, WebDriver driver) throws InterruptedException, IOException, AWTException {
		...
		fun.Click(driver, Prod_Li_xp.Abstract_Nature_Page);
		...
		// WebElement next =
		// driver.findElement(By.xpath("//*[@id='main']/nav[2]/ul/li[11]/a"));
		...
		try {
			...
			for (String product : products) {
				...
				XSSFSheet sheet = book.createSheet("Abstract_Nature");
...
//		            row0.createCell(0).setCellValue("Product List");
				...
				FileOutputStream out = new FileOutputStream(
						new File("C:\\eclipse\\orange_coast\\src\\test\\resources\\excel\\Abstract_Nature.xlsx")); // file
																													// name
																													// with
																													// path
				book.write(out);
